...
class ProfileViewModel: ObservableObject {
    ...
    func fetchUserProfile(userID: String) async throws {
        ...
        //참고하시면 좋습니다~
        //        do {
        //            self.userProfile =  try await db.collection("Users").document("1").getDocument(as: User.self)
        //        } catch {
    ...
    func fetchUserPosts(userID: String) async throws {
        ...
        //참고하시면 좋습니다~
//        let result = try await db.collection("Post").whereField("writerUid", isEqualTo: "1").getDocuments().documents
//        self.posts = try result.compactMap { snapshot in
